export default {
    accounts: {
      ...
      dataImportHint: '选择导出的 JSON 文件，或直接粘贴 JSON 内容，以批量导入账号与代理。',
      dataImportWarning: '导入内容包含账号凭据等敏感信息。导入将创建新账号与代理，分组需手工绑定；请确认已有数据不会冲突。',
      dataImportMode: '导入方式',
      dataImportModeFiles: '选择文件',
      ...
      dataImportPasteEmptyArray: '粘贴的 JSON 数组不能为空',
      dataImportPasteInvalidContent: '粘贴内容不是受支持的导出数据对象',
      dataImportPasteInvalidItem: 'JSON 数组第 {index} 项不是受支持的导出数据对象',
