export default {
    accounts: {
      ...
      dataImportHint: 'Select exported JSON files or paste JSON content to import accounts and proxies.',
      dataImportWarning: 'Imported data contains sensitive account credentials. Import creates new accounts/proxies; groups must be bound manually. Ensure existing data does not conflict.',
      dataImportMode: 'Import method',
      dataImportModeFiles: 'Select Files',
      ...
      dataImportPasteEmptyArray: 'The pasted JSON array cannot be empty',
      dataImportPasteInvalidContent: 'The pasted content is not a supported export data object',
      dataImportPasteInvalidItem: 'Item {index} in the JSON array is not a supported export data object',
